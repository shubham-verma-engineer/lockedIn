# 3. Database Design Specification (PostgreSQL DDL)

The database structures are intentionally normalization-balanced, binding structural unique composite indexes across constraints to insulate logging paths from multi-write double execution errors.
